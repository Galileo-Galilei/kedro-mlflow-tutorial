...
# kedro_mlflow_tutorial documentation build
...
from kedro_mlflow_tutorial import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_mlflow_tutorial"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
latex_documents = [
    (
        master_doc,
        "kedro_mlflow_tutorial.tex",
        "kedro_mlflow_tutorial Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_mlflow_tutorial",
        "Project kedro_mlflow_tutorial codebase.",
        "Data-Science",
    )
]
